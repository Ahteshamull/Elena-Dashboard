...
export const AdminSidebar = () => {
  ...
  return (
    <aside className="w-64 hidden md:flex flex-col bg-white border-r border-gray-100 h-[calc(100vh-80px)] sticky top-20">
      ...
      <div className="p-4 border-t border-gray-50">
        <button 
          ...
          className="w-full flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all rounded-xl group"
        >
